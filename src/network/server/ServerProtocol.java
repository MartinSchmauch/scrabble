 ...
 * to the Server class. This class is run as a thread and is created for every
 * connected client. The first message has to be a CONNECT_MESSAGE. If the
 * nickname exists on the server already, the client is rejected.
 * 
 * @author ldreyer
 */
...
public class ServerProtocol extends Thread {
	...
	/**
	 * Client messages are handled in this run method. First, the server awaits a
	 * CONNECT_MESSAGE with client information.
	 */
