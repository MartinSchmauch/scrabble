...
//		number.scaleYProperty().bind(slider.valueProperty()); //Stauchen und Strecken
		...
		//MouseListener für Chat Senden Knopf -> wenn geklickt, wird nachricht aus chatField hinzugefügt
		sendButton.setOnMouseClicked(new EventHandler<MouseEvent>() {

			@Override
			public void handle(MouseEvent click) {
				chatMessages.textProperty().setValue(chatMessages.textProperty().getValue() + "\n" + chatField.textProperty().getValue());
